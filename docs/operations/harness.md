...
| Nenhum preset de IA sobe por padrao na sessao do usuario | script shell pequeno | `tests/test_ai_default_service.sh` | zero `wantedBy = [ "default.target" ];` entre os presets `modules/ai/*.nix` |
